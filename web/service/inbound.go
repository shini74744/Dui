...
// GetInboundsByTrafficReset returns inbounds configured for the requested
// automatic traffic reset period (daily, weekly or monthly).
...
func (s *InboundService) UpdateInbound(inbound *model.Inbound) (*model.Inbound, bool, error) {
	...
	// LastTrafficResetTime is maintained by the reset job, not editable from the form.
...
// This keeps automatic resets scoped to the inbound that selected the period.
